        ...
        <div className='project-section'>
          ...
          <div className='text-container'>
            ...
            <p>
              ...
              user interface, built using the {lightningRef()} framework.
            </p>
          </div>
        </div>
      </AnimationOnScroll>
      ...
      >
        <div className='project-section'>
          ...
          <div className='text-container'>
            ...
            <p>
              As an engineering manager I have decided to start creating a
              series of repositories that offer hiring managers a resource to
              test potential candidates. The first example(
